...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var questionSeeds, questions;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prismaClient.question.deleteMany()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, prismaClient.questionnaire.deleteMany()];
                case 2:
                    _a.sent();
                    questionSeeds = [
                        {
                    ...
                    return [4 /*yield*/, Promise.all(questionSeeds.map(function (question) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, prismaClient.question.create({
                                            data: question,
                                        })];
                                    case 1:
                                        _a.sent();
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prismaClient.question.findMany()];
                case 4:
                    questions = _a.sent();
                    return [4 /*yield*/, Promise.all(questions.map(function (question) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, prismaClient.questionnaire.create({
                                            data: {
                                                meeting_id: 1,
